...
//CONNECT
/*
* Source: https://youtu.be/_mwWxgfZ7Zc?t=1120 (Apache, PHP & MySQL on Docker on Ubuntu)
* replace all oci commands with msqli commands (oci is for oracle db)
*/
    ...
    const con_string = '127.0.0.1:8000';  //on almighty "lab" is sufficient
