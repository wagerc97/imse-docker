...
class DatabaseHelper
{
	...
	const user = 'sql11502641'; 
	const password = 'DxUGZARlt7'; 
	const db = 'sql11502641';   // database name
...
//--------------------------- REPORT 1 ------------------------------
//-------------------------------------------------------------------
//----- Most expensive ordered products filtered by month  ----------
//-------------------------------------------------------------------
    public function selectProductsUnderPriceLimit($price_limit)
    {
        // Define the sql stmt string
        // The Docker time is 2h behind CET
        $sql = "SELECT p.ID_product, p.Product_Name, p.Indication, p.Price
                FROM Product p
...
//------------------- REPORT 2 ----------------------
//---------------------------------------------------
//---- 5 oldest employees filtered by gender --------
//---------------------------------------------------
public function selectClientInCountry($country_param)
{
    // Define the sql stmt string
    ...
    /*$sql = "SELECT Firstname, Lastname, Gender, Hire_date 
            FROM Employee
