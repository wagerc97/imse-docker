...
<div class="container"> <!-- Centering-->
	...
	<br>
	<div class="row "> 
		<div class="col-lg-12"><div class="p-4 border-dark bg-primary">

		<!-- header --> 
		<h1>
			Web Interface for SQL Database
		</h1>
		<h4>
		...
		<br>
		<h3>Switch to NoSQL Interface</h3>
			<a href="http://127.0.0.1:5000/about">
				<button>Switch</button>
			</a>
			<br>
		<!-- Link does not work :( --> 
		<!--<h3>Switch to Landing Page</h3>
			<a href="http://127.0.0.1:8000/">
				<button>Switch to LP</button>
			</a> -->
	</div>
</div>
</div>
	...
	<div class="row"> 
		<div class="col-lg-12"><div class="p-4 border bg-light">
				...
				<h5>Please fill in the Client information:</h5>
	...
	<div class="row"> 
		<div class="col-lg-12"><div class="p-4 border bg-light">
			...
			<h4>[MAIN USE CASE 1]</h4>
			<h5>This is a list of the newest 10 clients that were registered</h5>
			<br>
	...
	<div class="row"> 
		<div class="col-lg-12"><div class="p-4 border bg-light">
			...
			<h5>Please fill in the Product information:</h5>
	...
	<div class="row"> 
		<div class="col-lg-12"><div class="p-4 border bg-light">
		<h3>Report the five most expensive products priced below the given price limit</h3>
		<h5>Filter by price limit</h5>
			<h4>[REPORT 1]</h4>
				<!-- opens confirmation page to let user know the INSERT was successul --> 
				<form method="post" action="reportProducts.php">
				<!-- Region name textbox -->
				<div>
					<label for="price_limit">Choose a price limit:</label> 
					<input id="price_limit" name="price_limit" type="text" placeholder='00.00' max="99999">
				</div>
				<br>
	...
	<!----------------------------------------------------------------------------------------------------------------------------->
	<!-------------------------------------- REPORT 2: Clients in given country --------------------------------------------------->
	<!----------------------------------------------------------------------------------------------------------------------------->

	<div class="row"> 
		<div class="col-lg-12"><div class="p-4 border bg-light">
		<h3>Report clients in alphabetical order</h3>
		<h5>Filter by country </h5>
			<h4>[REPORT 2]</h4>
				<!-- opens confirmation page to let user know the INSERT was successul --> 
				<form method="post" action="reportClientInCountry.php">
				<!-- Region name textbox -->
				<div>
					<label for="country_param">Choose a country:</label> 
					<input id="country_param" name="country_param" type="text" placeholder='Austria, etc.' maxlength="30">
				</div>
				<br>
				<!-- Submit button sends request and leads to a result page -->
				<div>
